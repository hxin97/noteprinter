...
import static com.example.printassistant.MainActivity.MY_PERMISSION_REQUEST_CONSTANT;
...
//                            //在列表中显示扫描到的蓝牙设备
//                            tv_count.setText(String.format(mContext.getString(R.string.bottom_sheet_text),devicesList_final.size()));
